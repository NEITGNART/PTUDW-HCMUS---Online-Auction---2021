...
const adminController = {
    ...
    deleteProduct: async (req, res) => {
        ...
        if (!product) {
            ...
            let user = await UserModel.find({ "wishlist": id });
            ...
            user = await UserModel.find({ "currentBiddingList.idProduct": id });
            ...
            user = await UserModel.find({ "winBiddingList.idProduct": id });
